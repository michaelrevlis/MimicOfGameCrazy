...
class GameProducerTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        self.tableView.register(nib, forCellReuseIdentifier: "gameproducerTableCell")
        
        let nib2 = UINib(nibName: "ADTableViewCell", bundle: nil)
        self.tableView.register(nib2, forCellReuseIdentifier: "Ad3TableViewCell")
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        switch sections[indexPath.section] {
        case .ad:
            let adCell = tableView.dequeueReusableCell(withIdentifier: "Ad3TableViewCell", for: indexPath) as! ADTableViewCell
        ...
        case .playlist:
            let cell = tableView.dequeueReusableCell(withIdentifier: "gameproducerTableCell", for: indexPath) as! PlaylistTableViewCell
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        switch sections[indexPath.section] {
        case .ad:
            self.performSegue(withIdentifier: "showAd3", sender: indexPath.row)
        case .playlist:
            self.performSegue(withIdentifier: "showProducer", sender: indexPath.row)
        }
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if let identifier = segue.identifier {
            switch identifier {
            case "showProducer":
                let webVC = segue.destination as! ProducerViewController
